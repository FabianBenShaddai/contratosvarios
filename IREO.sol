...
contract IREO is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    constructor(address [] memory payees,uint256 [] memory shares_)PaymentSplitter (payees, shares_) ERC721("Burjh Khalifa", "BK") {}
